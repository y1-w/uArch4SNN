...
#pragma HLS ARRAY_PARTITION variable=registerfile complete dim=0
    ...
    instr_mem[  3] = 0b00000000000101000000000000001010;    //mov num, #00, d10,
    ...
    instr_mem[  8] = 0b00100011100011000000000000001010;    //mul weight_ddr_addr, src_id, #00, d10
    instr_mem[  9] = 0b00000000001000000000000000000000;    //mov weight_addr, #00, #0, d10
    instr_mem[ 10] = 0b10100100000111001010000000000001;    //ldw weight_addr, weight_ddr_addr, num, #0001
    instr_mem[ 11] = 0b10110100000110000000000000000001;    //rwp weight_addr, potential_addr, #0001, #0001
    instr_mem[ 12] = 0b11000011000000000000000000000001;    //acc potential_addr, #0001, #0001, #0001
    ...
    instr_mem[ 19] = 0b11010010000000010000000000000001;    //ckf potential_idx, #0001000000000000, #0001, #1
