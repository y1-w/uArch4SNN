...
#define CURRENT_CLUSTER_ID 					0
#define CURRENT_CLUSTER_SPIKEMEM 			spike_mem_0
#define CURRENT_CLUSTER_PRESPIKEMEM 		prespike_mem_0
#define CURRENT_CLUSTER_NUM_PRESPIKEMEM 	cur_addr_prespike_mem_0

#define DDR_ADDR_SHIFT_CLST					0
#define NUM_PRENEURON						784

int cluster_0(volatile ap_int<32> *ddr_0, struct SpikeMemList *spike_mem_list, ap_uint<1> *cluster_done, ap_uint<1> *cluster_exit, ap_uint<WIDTH_INSTR_MEM_pointer> *idx_instr, ap_uint<32> *time_step, ap_uint<WIDTH_IN_MEM_pointer> in_mem_idx, int *test, Potential_Mem_Type_ *potential_mem_PE1, Potential_Mem_Type_ *potential_mem_PE2, Potential_Mem_Type_ *potential_mem_PE3, Potential_Mem_Type_ *potential_mem_PE4, ap_uint<WIDTH_INPUT_MEM> *input_mem)
{
...
#pragma HLS ARRAY_PARTITION variable=registerfile complete dim=0
    ...
    instr_mem[  4] = 0b10000001101010010010000000000000;    //rdi src_id, spike_step, input_spike_idx,
    ...
    instr_mem[ 19] = 0b11010010000001000000000000001111;    //ckf potential_idx, #0100000000000000, #1111, #1
