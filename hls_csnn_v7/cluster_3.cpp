...
void RunCluster_3(ap_uint<4> ClusterID, volatile ap_int<32> *ddr_0, struct sClstInputPkg *ClstInputPkg, struct sSpikeMemPkg *SpikeMemPkg, struct sOutputMemPkg *OutputMemPkg, _reg_timestep GlobalTimeStep, struct sClstOutputPkg *ClstOutputPkg)
{
	*((ClstInputPkg+ClusterID)->ClstDone) = 0;
    *((ClstInputPkg+ClusterID)->ClstSync) = 0;
	*((ClstInputPkg+ClusterID)->TimeStep) = GlobalTimeStep;

	ClstOutputPkg[ClusterID] = Cluster_3(ddr_0, ClstInputPkg+ClusterID, SpikeMemPkg, OutputMemPkg+ClusterID);
}